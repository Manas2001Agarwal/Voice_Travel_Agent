"""Test integration of evaluations with existing agent."""
import asyncio
import sys
import os
import io
...
async def test_integration():
    """Test that evaluations work without breaking existing functionality."""
    print("=" * 70)
    ...
    try:
        ...
        # Check if evaluation_results.json was created
