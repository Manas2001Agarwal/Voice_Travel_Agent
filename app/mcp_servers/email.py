"""Email MCP server for sending itineraries via Resend."""
import logging
import os
import httpx
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="background-color: #4f46e5; padding: 20px 30px; text-align: center;">
            <h2 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 500;">📍 {destination}</h2>
        </div>
        ...
        <div style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
            ...
            <p style="margin: 0; color: #9ca3af; font-size: 12px;">
                Generated by Voice Travel Agent • Powered by ElevenLabs, Groq, and LangGraph
            </p>
        </div>
    </div>
</body>
